...
Gig.create!(user_id: 1, title: "Will write you a biography!", category: "writing",
      ...
      delivery_time: 5, revisions: 3, price: 5, gig_vies: 8)
...
Review.create!( gig_id:1, user_id:8, body: "The produce is phenomenal and they put so much heart into it.", rating: 5)
Review.create!( gig_id:2, user_id:8, body: "Hats off to you!", rating: 4 )
Review.create!( gig_id:3, user_id:4, body: "The logo was beautiful!", rating: 5)
Review.create!( gig_id:4, user_id:1, body: "Did a pretty good job.", rating: 3)
Review.create!( gig_id:5, user_id:6, body: "Many regrets", rating: 1)
Review.create!( gig_id:6, user_id:2, body: "My team is stacked!", rating: 5)
Review.create!( gig_id:7, user_id:3, body: "Wow that was so simple!", raiting: 4)
Review.create!( gig_id:8, user_id:5, body: "*wold whistle*", rating: 5)
Review.create!( gig_id:9, user_id:7, body: "Love the flow of the design", rating: 4)
Review.create!( gig_id:10, user_id:6, body: "Did not deliver on time", rating: 2)
Review.create!( gig_id:11, user_id:7, body: "It's pretty simplistic", rating: 3)
Review.create!( gig_id:9, user_id:1, body: "Perfect feng shui", rating: 5)
Review.create!( gig_id:3, user_id:3, body: "Pleasure working with you", rating: 5)
Review.create!( gig_id:4, user_id:8, body: "Notes were helpful", rating: 4)
Review.create!( gig_id:11, user_id:4, body: "Not what I expected", rating: 2)
Review.create!( gig_id:7, user_id:5, body: "Now you see me, now you...", rating: 5)
